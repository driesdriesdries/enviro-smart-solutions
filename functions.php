...
if ( ! function_exists( 'envirosmartsolutions_setup' ) ) :
	/**
	...
	function envirosmartsolutions_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'envirosmartsolutions_custom_background_args', array(
...
function envirosmartsolutions_scripts() {
	wp_enqueue_style( 'envirosmartsolutions-style', get_stylesheet_uri() );

	wp_enqueue_script( 'envirosmartsolutions-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'envirosmartsolutions-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
